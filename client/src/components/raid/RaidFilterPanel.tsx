...
export function RaidFilterPanel({ bosses, seasons }: Props) {
  ...
  return (
    <div className="bg-white/80 backdrop-blur border border-purple-100 shadow-sm rounded-lg p-4 mb-6">
      ...
      <h2 className="text-xl font-bold text-gray-800 mb-4">보스 선택</h2>
