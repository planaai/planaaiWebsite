            ...
            {menuGroups.map((group, groupIdx) => {
              ...
              return (
                <div key={group.title} className="flex flex-col fade-in-anim" style={{ animationDelay: `${groupIdx * 0.15}s` }}>
                  ...
                  <div 
                    className={`grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 pl-2 md:pl-6 transition-all duration-500 origin-top overflow-hidden
                      ${isExpanded ? 'max-h-[1000px] opacity-100 mt-5 scale-y-100' : 'max-h-0 opacity-0 mt-0 scale-y-0'}
                    `}
                  >
